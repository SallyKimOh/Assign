...
public class TestComplexCalculator3 {
   ...
   public static void main(String[] args) {
      ...
      while(true){   //loop until 'Q' entered by user, below
    	 Complex c1 = TestComplexCalculator3.getComplexNumber();  // read in the 1st complex number
    	 Complex c2 = TestComplexCalculator3.getComplexNumber();  // read in the 2nd complex number
   ...
   private static Complex getComplexNumber(){
   	   ...
   	   choice = TestComplexCalculator3.displayTypeInputMenu();
