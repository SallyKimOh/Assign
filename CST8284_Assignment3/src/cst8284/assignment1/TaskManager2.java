...
public class TaskManager2 extends Application {
...
//		File f = fc.showSaveDialog(getPrimaryStage());
//		if (f != null) {
//			  if (f.getName().endsWith(".todo")) {
//			    // do the operation with the file (i used a builder)
//			  } else {
//			    try {
//					throw new Exception(f.getName() + " has no valid file-extension.");
//				} catch (Exception e) {
...
/*				
	...
	//		        is = new FileInputStream("testOnlyFirst.todo");
			        os = new FileOutputStream(fUtils.getAbsPath());
...
//		
//		toDoArray.clear();
//		toDoArray.addAll(toDoArray2);
//		setToDoArray(toDoArray);
		
		
//	    	fUtils.getToDoArray(fUtils.getAbsPath());
	}
...
//		setTempDate(datePicker);
	...
	private ToDo[] getToDoArrayWithoutEmpties1(ToDo[] tdRawAr) {
		int toElement = 0;
