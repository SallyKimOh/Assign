...
public class AgeCalculator5 {
	...
	public AgeCalculator5(){		// Default constructor (call both OurDate default constructors)
	...
	public void calculateMessage(){	// Calculate the correct message
		...
		System.out.println("gapDay:"+gapDay);
		System.out.println("ntDay:"+ntDay);
		...
		System.out.println("ntMonth:"+ntMonth);
		System.out.println("nbMonth:"+nbMonth);
